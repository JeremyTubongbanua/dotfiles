...
// Tools
const PLAN_MODE_TOOL_PREFERENCES = ["read", "bash", "grep", "find", "ls", "questionnaire"];
const FALLBACK_NORMAL_TOOLS = ["read", "bash", "edit", "write", "grep", "find", "ls"];
...
export default function planModeExtension(pi: ExtensionAPI): void {
	...
	function planTools(): string[] {
		return availableTools(PLAN_MODE_TOOL_PREFERENCES);
	}

	function normalTools(): string[] {
		return availableTools(restoreTools ?? FALLBACK_NORMAL_TOOLS);
	}
...
Ask clarifying questions before planning if requirements are unclear.
